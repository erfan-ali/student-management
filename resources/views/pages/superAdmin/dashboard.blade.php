                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"></div>
                                                 <a href="{{route('students')}}"class="btn btn-info btn=sm"align="center">All Students</a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="{{route('users')}}"class="btn btn-warning btn=sm">All Users</a>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1"></div>
                                            <a href="{{route('teachers')}}"class="btn btn-warning btn=sm">All Teachers</a>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="{{route('monthlyPay')}}"class="btn btn-success btn=sm">Monthly Payment</a>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
